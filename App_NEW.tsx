...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (currentView) {
        case 'dashboard': return <DashboardView setMobileMenuOpen={setMobileMenuOpen} onAskAI={handleAskAI} onNavigate={setCurrentView} />;
        ...
        default: return <DashboardView setMobileMenuOpen={setMobileMenuOpen} onAskAI={handleAskAI} onNavigate={setCurrentView} />;
    }
  };
